# Todo
List of ideas what to implement for local server multiparty bots activites.

1. Spread targets across characters on same spot to prevent overhit with ranged attacks
2. Enable merchants
